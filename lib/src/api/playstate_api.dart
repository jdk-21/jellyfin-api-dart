...
class PlaystateApi {
  ...
  Future<Response<UserItemDataDto>> markPlayedItem({ 
    ...
    final _path = r'/Users/{userId}/PlayedItems/{itemId}'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString()).replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
  ...
  Future<Response<void>> onPlaybackProgress({ 
    ...
    final _path = r'/Users/{userId}/PlayingItems/{itemId}/Progress'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString()).replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> onPlaybackStart({ 
    ...
    final _path = r'/Users/{userId}/PlayingItems/{itemId}'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString()).replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
