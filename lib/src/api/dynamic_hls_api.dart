...
class DynamicHlsApi {
  ...
  Future<Response<Uint8List>> getHlsAudioSegment({ 
    ...
    final _path = r'/Audio/{itemId}/hls1/{playlistId}/{segmentId}.{container}'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString()).replaceAll('{' r'playlistId' '}', encodeQueryParameter(_serializers, playlistId, const FullType(String)).toString()).replaceAll('{' r'segmentId' '}', encodeQueryParameter(_serializers, segmentId, const FullType(int)).toString()).replaceAll('{' r'container' '}', encodeQueryParameter(_serializers, container, const FullType(String)).toString());
  ...
  Future<Response<Uint8List>> getHlsVideoSegment({ 
    ...
    final _path = r'/Videos/{itemId}/hls1/{playlistId}/{segmentId}.{container}'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString()).replaceAll('{' r'playlistId' '}', encodeQueryParameter(_serializers, playlistId, const FullType(String)).toString()).replaceAll('{' r'segmentId' '}', encodeQueryParameter(_serializers, segmentId, const FullType(int)).toString()).replaceAll('{' r'container' '}', encodeQueryParameter(_serializers, container, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      responseType: ResponseType.bytes,
      headers: <String, dynamic>{
  ...
  Future<Response<Uint8List>> getLiveHlsStream({ 
    ...
    final _path = r'/Videos/{itemId}/live.m3u8'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      responseType: ResponseType.bytes,
      headers: <String, dynamic>{
  ...
  Future<Response<Uint8List>> getMasterHlsAudioPlaylist({ 
    ...
    final _path = r'/Audio/{itemId}/master.m3u8'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      responseType: ResponseType.bytes,
      headers: <String, dynamic>{
  ...
  Future<Response<Uint8List>> getMasterHlsVideoPlaylist({ 
    ...
    final _path = r'/Videos/{itemId}/master.m3u8'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      responseType: ResponseType.bytes,
      headers: <String, dynamic>{
  ...
  Future<Response<Uint8List>> getVariantHlsAudioPlaylist({ 
    ...
    final _path = r'/Audio/{itemId}/main.m3u8'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      responseType: ResponseType.bytes,
      headers: <String, dynamic>{
  ...
  Future<Response<Uint8List>> getVariantHlsVideoPlaylist({ 
    ...
    final _path = r'/Videos/{itemId}/main.m3u8'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      responseType: ResponseType.bytes,
      headers: <String, dynamic>{
