...
class LibraryApi {
  ...
  Future<Response<BaseItemDtoQueryResult>> getCriticReviews({ 
    ...
    final _path = r'/Items/{itemId}/CriticReviews'.replaceAll('{' r'itemId' '}', encodeQueryParameter(_serializers, itemId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<LibraryOptionsResultDto>> getLibraryOptionsInfo({ 
    ...
    final _queryParameters = <String, dynamic>{
      if (libraryContentType != null) r'libraryContentType': encodeQueryParameter(_serializers, libraryContentType, const FullType(String)),
