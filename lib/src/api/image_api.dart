...
class ImageApi {
  ...
  Future<Response<void>> deleteUserImage({ 
    ...
    final _path = r'/Users/{userId}/Images/{imageType}'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString()).replaceAll('{' r'imageType' '}', encodeQueryParameter(_serializers, imageType, const FullType(ImageType)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> deleteUserImageByIndex({ 
    ...
    final _path = r'/Users/{userId}/Images/{imageType}/{index}'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString()).replaceAll('{' r'imageType' '}', encodeQueryParameter(_serializers, imageType, const FullType(ImageType)).toString()).replaceAll('{' r'index' '}', encodeQueryParameter(_serializers, index, const FullType(int)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<Uint8List>> getUserImageByIndex({ 
    ...
    final _path = r'/Users/{userId}/Images/{imageType}/{imageIndex}'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString()).replaceAll('{' r'imageType' '}', encodeQueryParameter(_serializers, imageType, const FullType(ImageType)).toString()).replaceAll('{' r'imageIndex' '}', encodeQueryParameter(_serializers, imageIndex, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      responseType: ResponseType.bytes,
      headers: <String, dynamic>{
