...
class UserApi {
  ...
  Future<Response<AuthenticationResult>> authenticateUser({ 
    ...
    final _path = r'/Users/{userId}/Authenticate'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
  ...
  Future<Response<void>> updateUserConfiguration({ 
    ...
    final _path = r'/Users/{userId}/Configuration'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> updateUserEasyPassword({ 
    ...
    final _path = r'/Users/{userId}/EasyPassword'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _bodyData = _serializers.serialize(updateUserEasyPassword, specifiedType: _type);
  ...
  Future<Response<void>> updateUserPassword({ 
    ...
    final _path = r'/Users/{userId}/Password'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
