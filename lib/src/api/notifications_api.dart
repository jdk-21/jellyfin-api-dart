...
class NotificationsApi {
  ...
  Future<Response<void>> createAdminNotification({ 
    ...
    try {
      ...
      _bodyData = _serializers.serialize(adminNotificationDto, specifiedType: _type);
  ...
  Future<Response<BuiltList<NameIdPair>>> getNotificationServices({ 
    ...
    final _path = r'/Notifications/Services';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<NotificationResultDto>> getNotifications({ 
    ...
    final _path = r'/Notifications/{userId}'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<NotificationsSummaryDto>> getNotificationsSummary({ 
    ...
    final _path = r'/Notifications/{userId}/Summary'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> setRead({ 
    ...
    final _path = r'/Notifications/{userId}/Read'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> setUnread({ 
    ...
    final _path = r'/Notifications/{userId}/Unread'.replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
