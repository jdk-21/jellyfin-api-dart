...
/// * [currentProgram] 
@BuiltValue()
abstract class SessionInfoNowPlayingItem implements BaseItemDto, Built<SessionInfoNowPlayingItem, SessionInfoNowPlayingItemBuilder> {
  SessionInfoNowPlayingItem._();

  factory SessionInfoNowPlayingItem([void updates(SessionInfoNowPlayingItemBuilder b)]) = _$SessionInfoNowPlayingItem;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SessionInfoNowPlayingItemBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SessionInfoNowPlayingItem> get serializer => _$SessionInfoNowPlayingItemSerializer();
}

class _$SessionInfoNowPlayingItemSerializer implements PrimitiveSerializer<SessionInfoNowPlayingItem> {
  @override
  final Iterable<Type> types = const [SessionInfoNowPlayingItem, _$SessionInfoNowPlayingItem];

  @override
  final String wireName = r'SessionInfoNowPlayingItem';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SessionInfoNowPlayingItem object, {
  ...
  void _deserializeProperties(
    ...
    required SessionInfoNowPlayingItemBuilder result,
  ...
  @override
  SessionInfoNowPlayingItem deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SessionInfoNowPlayingItemBuilder();
