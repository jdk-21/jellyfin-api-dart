...
part 'session_info_now_viewing_item.g.dart';
...
/// * [currentProgram] 
@BuiltValue()
abstract class SessionInfoNowViewingItem implements BaseItemDto, Built<SessionInfoNowViewingItem, SessionInfoNowViewingItemBuilder> {
  SessionInfoNowViewingItem._();

  factory SessionInfoNowViewingItem([void updates(SessionInfoNowViewingItemBuilder b)]) = _$SessionInfoNowViewingItem;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SessionInfoNowViewingItemBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SessionInfoNowViewingItem> get serializer => _$SessionInfoNowViewingItemSerializer();
}

class _$SessionInfoNowViewingItemSerializer implements PrimitiveSerializer<SessionInfoNowViewingItem> {
  @override
  final Iterable<Type> types = const [SessionInfoNowViewingItem, _$SessionInfoNowViewingItem];

  @override
  final String wireName = r'SessionInfoNowViewingItem';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SessionInfoNowViewingItem object, {
  ...
  void _deserializeProperties(
    ...
    required SessionInfoNowViewingItemBuilder result,
  ...
  @override
  SessionInfoNowViewingItem deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SessionInfoNowViewingItemBuilder();
