...
/// * [currentProgram] 
@BuiltValue()
abstract class PlaybackProgressInfoItem implements BaseItemDto, Built<PlaybackProgressInfoItem, PlaybackProgressInfoItemBuilder> {
  PlaybackProgressInfoItem._();

  factory PlaybackProgressInfoItem([void updates(PlaybackProgressInfoItemBuilder b)]) = _$PlaybackProgressInfoItem;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PlaybackProgressInfoItemBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PlaybackProgressInfoItem> get serializer => _$PlaybackProgressInfoItemSerializer();
}

class _$PlaybackProgressInfoItemSerializer implements PrimitiveSerializer<PlaybackProgressInfoItem> {
  @override
  final Iterable<Type> types = const [PlaybackProgressInfoItem, _$PlaybackProgressInfoItem];
