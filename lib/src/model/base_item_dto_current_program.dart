...
part 'base_item_dto_current_program.g.dart';
...
class _$BaseItemDtoCurrentProgramSerializer implements PrimitiveSerializer<BaseItemDtoCurrentProgram> {
  ...
  void _deserializeProperties(
    ...
    required BaseItemDtoCurrentProgramBuilder result,
  ...
  @override
  BaseItemDtoCurrentProgram deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BaseItemDtoCurrentProgramBuilder();
