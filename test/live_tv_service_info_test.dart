...
// tests for LiveTvServiceInfo
void main() {
  final instance = LiveTvServiceInfoBuilder();
  // TODO add properties to the builder and call build()

  group(LiveTvServiceInfo, () {
    ...
    // BuiltList<String> tuners
    test('to test the property `tuners`', () async {
      // TODO
    });
